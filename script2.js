...
//When score history is clicked a list of full users and score is displayed
...
function highScores() {
    ...
    body.appendChild(userScoreList)
...
function gameOver() {
    ...
    scoreSubmit.appendChild(userInput)
    setTimeout(function() {
        contents.textContent = "enter your name below and press enter to save your score"
    }, 2000);
